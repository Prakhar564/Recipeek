...
const Homepage = (props) => {
  ...
  return (
    <div className={`home-container ${themeClassName}`}>
      <Helmet>
        <title>Charming Imaginary Sparrow</title>
        ...
        <div className="home-hero1 heroContainer">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Your Ultimate Cloud-Based Recipe Application</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>Discover the powerful features of Recipeek</span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: ' ',
            ...
            <div className="home-container03">
              <FeatureCard
                subHeading="Discover personalized recipe recommendations tailored to your tastes and preferences. Receive curated recipe suggestions based on your dietary restrictions and cooking habits."
                heading="Recipe recommender"
              ></FeatureCard>
              <FeatureCard
                heading="Dietary Customization"
                subHeading="Personalize your meals with dietary customization options, ensuring recipes align with your nutritional needs and lifestyle choices."
              ></FeatureCard>
              <FeatureCard
                heading="Ingrediant Recognition"
                subHeading="Streamline your cooking process with ingredient recognition, allowing you to effortlessly identify and incorporate ingredients into your recipes with just a snap"
              ></FeatureCard>
              <FeatureCard
                heading="Cooking Assistant"
                subHeading="Enhance your culinary experience with a virtual cooking assistant that provides step-by-step guidance, cooking tips, and timers to ensure perfect results."
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Unlock the full potential of Recipeek with our flexible
                  pricing options
                </span>
              </span>
            </span>
            ...
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">
                    Access to basic recipe management
                  </span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">
                    Limited cloud storage for recipes
                  </span>
                </div>
                <div className="home-container11">
                  <span className="home-text42">✔</span>
                  <span className="bodySmall">
                    Basic recipe sharing options
                  </span>
                </div>
                <div className="home-container12">
                  <span className="home-text43">✔</span>
                  <span className="bodySmall">Standard customer support</span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">Unlimited recipe management</span>
                </div>
                <div className="home-container18">
                  <span className="home-text52">✔</span>
                  <span className="bodySmall">
                    Expanded cloud storage for recipes
                  </span>
                </div>
                <div className="home-container19">
                  <span className="home-text53">✔</span>
                  <span className="bodySmall">
                    Enhanced recipe sharing options
                  </span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container23">
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">
                    Advanced recipe organization tools
                  </span>
                </div>
                <div className="home-container26">
                  <span className="home-text65">✔</span>
                  <span className="bodySmall">
                    Large cloud storage capacity for recipes
                  </span>
                </div>
                <div className="home-container27">
                  <span className="home-text66">✔</span>
                  <span className="bodySmall">
                    Customizable recipe sharing options
                  </span>
                </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">Discover the Recipes</h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Recipeek leverages cloud services like AWS to provide you with
                  a scalable, reliable, and geographically accessible recipe
                  management experience. Our core components run on cloud VMs,
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer=" Recipeek is a comprehensive platform designed to revolutionize your culinary journey, offering a wide array of features including recipe recommendations, dietary customization, ingredient recognition, and cooking assistance."
                question="What is Recipeek?"
              ></Question1>
              <Question1
                answer="Recipeek works by providing users with a range of features to enhance their cooking experience. Users can explore a vast collection of recipes tailored to their preferences and dietary needs, customize their meals based on specific dietary requirements, utilize ingredient recognition technology to identify ingredients, and receive cooking assistance through step-by-step instructions and tips."
                question="How does Recipeek work?"
              ></Question1>
              <Question1
                answer="Recipeek supports iOS and Android devices through its frontend developed using React Native."
                question="What platforms does Recipeek support?"
              ></Question1>
              <Question1
                answer="Recipeek's key features  are listed above."
                question="What are the key features of Recipeek?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          ...
          <div className="home-container32">
            <span className="bodySmall home-text89">
              © 2024 - present Recipeek, All Rights Reserved.
            </span>
