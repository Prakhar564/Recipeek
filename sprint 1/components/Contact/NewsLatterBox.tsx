...
const NewsLatterBox = () => {
  ...
  return (
    ...
    >
      ...
      Sign up to receive the latest news, updates, and exclusive offers straight to your inbox. Don't miss out on exciting features, new recipes, and helpful cooking tips. Join our community of food enthusiasts and elevate your culinary experience today!
      </p>
      <div>
        <input
          type="text"
